...
AUTHENTICATION_BACKENDS = ['api_crud.backend.EmailOrUsernameModelAuthenticationBackend']

SPECTACULAR_SETTINGS = {
    'TITLE': 'Simple Crud Movie Rating API',
    'DESCRIPTION': 'A simple crud movie rating api.',
    'VERSION': '1.0.0',
